...
public class ParamKitchenListByCuisine {
    ...
    public ParamKitchenListByCuisine(String per_page_item, String offset, String lat, String lng, String cusine, String app_user_id) {
