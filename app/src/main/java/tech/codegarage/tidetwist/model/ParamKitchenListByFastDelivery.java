 ...
 */
public class ParamKitchenListByFastDelivery {
    ...
    public ParamKitchenListByFastDelivery(String per_page_item, String offset, String lat, String lng, String app_user_id) {
