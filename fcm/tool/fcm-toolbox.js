...
var DEFAULT_APP_SETTINGS = {
    fcm: {
        apiKey: "AAAA7_jlqcw:APA91bHFykjQ1GK0KDcfnrkAXFsV61_COlWCIB6skgt2gAUs_TKBzj_g6TyjpQs1ENkBSciyWliVw_Qq7hoUGeDCawiIJK8GAH93N7m2Dqz0kApFtF9x3J4DlW8F5L_dza8LLenYJFmn",
        ttl: 60,
        priority: "high"
    },
    frd: {
        ...
        case "#send-app":
            payload.data = {
                app: {
                    ...
                    packageName: $("#send-app-package").val()
                }
            };
            break;
        case "#send-raw":
