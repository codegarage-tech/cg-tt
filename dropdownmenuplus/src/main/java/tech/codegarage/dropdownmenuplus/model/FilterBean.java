...
public class FilterBean implements Serializable {
    ...
    //价格数据
    private ArrayList<ItemBean> price;//价格
    //区域数据
    private ArrayList<TitleBean> area;//省市区数据

    public ArrayList<TitleBean> getTitleBeans() {
        return area;
    }

    public void setTitleBeans(ArrayList<TitleBean> titleBeans) {
        this.area = titleBeans;
    }
    ...
    public ArrayList<TitleBean> getArea() {
        return area;
    }

    public void setArea(ArrayList<TitleBean> area) {
        this.area = area;
    }
    ...
    public void setItemBeans(ArrayList<ItemBean> price) {
        this.price = price;
    }
