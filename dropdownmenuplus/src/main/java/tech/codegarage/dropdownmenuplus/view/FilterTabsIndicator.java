package tech.codegarage.dropdownmenuplus.view;
...
public class FilterTabsIndicator extends LinearLayout {
    ...
    public void setTabDefaultColor(int defaultColor){
        mTabDefaultColor = defaultColor;
    }

    public void setTabSelectedColor(int selectedColor){
