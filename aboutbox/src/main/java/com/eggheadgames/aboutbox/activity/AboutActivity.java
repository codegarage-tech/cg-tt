...
//        getSupportActionBar().setDisplayShowTitleEnabled(false);
    ...
    private MaterialAboutCard buildSupportCard(final AboutConfig config) {
        ...
        card.addItem(itemHelper(R.string.egab_contact_support, R.drawable.ic_email_blue,
                new MaterialAboutItemOnClickAction() {
                    @Override
                    public void onClick() {
    ...
    private MaterialAboutCard buildShareCard(final AboutConfig config) {
        ...
        if (config.buildType != null && !TextUtils.isEmpty(config.packageName)) {
            card.addItem(itemHelper(R.string.egab_leave_review, R.drawable.ic_review_blue,
                    new MaterialAboutItemOnClickAction() {
                        @Override
                        public void onClick() {
        ...
        card.addItem(itemHelper(R.string.egab_share, R.drawable.ic_share_blue,
                new MaterialAboutItemOnClickAction() {
                    @Override
                    public void onClick() {
    ...
    private MaterialAboutCard buildSocialNetworksCard(final AboutConfig config) {
        ...
        if (!TextUtils.isEmpty(config.webHomePage)) {
            card.addItem(new MaterialAboutActionItem.Builder()
                    ...
                    .icon(R.drawable.ic_web_blue_24dp)
                    .setOnClickAction(new MaterialAboutItemOnClickAction() {
                        @Override
                        public void onClick() {
    ...
    private MaterialAboutCard buildPrivacyCard(final AboutConfig config) {
        ...
        if (!TextUtils.isEmpty(config.privacyHtmlPath)) {
            card.addItem(itemHelper(R.string.egab_privacy_policy, R.drawable.ic_privacy_blue,
                    new MaterialAboutItemOnClickAction() {
                        @Override
                        public void onClick() {
//                            if (config.dialog == null) {
...
//                            }
        ...
        card.addItem(itemHelper(R.string.egab_third_party_notice, R.drawable.ic_license_blue_vertical,
                new MaterialAboutItemOnClickAction() {
                    @Override
                    public void onClick() {
